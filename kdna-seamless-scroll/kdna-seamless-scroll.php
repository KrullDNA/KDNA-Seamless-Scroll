...
function kdna_sps_default_options() {
	return array(
		...
		'marquee_speed'      => 0.7,    // pixels per tick for .marquee / .marquee2 strips
		...
		'persistent_selectors' => '',        // CSS selectors (one per line) pinned across the crossfade, e.g. the header/logo
